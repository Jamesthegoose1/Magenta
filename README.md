...
2. Create an Access Key (Get them from https://uglyburger0.com/tools/uuid as it is easy and simple)
...
5. Make sure that the .env loaded correctly if not then load it in the varibles manually
